...
const ParkSvg = ({ scale }) => {
  return (
    ...
    >
      ...
      <rect x="221.98" y="205.48" width="101.33" height="9.33" fill="#43bd16" />
      <rect
        x="221.98"
        y="250.98"
        width="101.33"
      ...
      <path
        ...
        fill="#43bd16"
      />
      <circle cx="647.55" cy="275.37" r="11.13" fill="#43bd16" />
      <path
      ...
      <ellipse
        ...
        opacity="0.1"
      />
      <ellipse cx="893.79" cy="850.05" rx="40.21" ry="6.8" fill="#43bd16" />
      <path
